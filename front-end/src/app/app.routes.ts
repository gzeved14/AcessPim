...
loadComponent: () => import('./features/acessos/registrar-acesso/registrar-acesso')
  .then(m => m.RegistrarAcesso),
  },
  {
    path: 'acessos',
    canActivate: [authGuard],
  ...
  { path: 'areas/nova', canActivate: [authGuard], 
  loadComponent: () => import('./features/areas/area-form').then(m => m.AreaForm) },
{ path: 'areas/editar/:id', canActivate: [authGuard], 
  loadComponent: () => import('./features/areas/area-form').then(m => m.AreaForm) },
  
  {
    ...
    loadComponent: () => import('./features/colaboradores/colaborador-form/colaborador-form').then(m => m.ColaboradorForm)
  },
  {
